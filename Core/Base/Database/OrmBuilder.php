...
use Core\Base\Database\Grammar;
use Core\Base\Database\Processor;
use Core\Base\Database\JoinClause;
...
class OrmBuilder
{
    ...
    public function connect($database){
        ...
        $this->connection->setDb($database);
    }
     ...
     * @return array
     */
    public function simpleGet($sql,$bind=[]){
        return $this->connection->select($sql,$bind);
    }
    /**
     ...
     *
     * @param  \Closure|OrmBuilder|string $query
     * @param  string  $as
     * @return OrmBuilder|static
     */
     ...
     *
     * @param  OrmBuilder|\Closure  $query
     * @param  bool  $all
     * @return OrmBuilder|static
     */
    ...
    public function update(array $values)
    {
        ...
        return $this->connection->statement($sql, $this->cleanBindings($bindings));
    }
     ...
     * @return $this
     */
    public function mergeBindings(OrmBuilder $query)
    {
